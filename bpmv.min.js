...
b&&this.trueish("undefined"==typeof e?!0:!1))return g.substr(g.length-b,g.length-(g.length-b));if(g.length>b)return a}},rescape:function(a){return!this.str(a)?a:String(a).replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")},reverse:function(a){if(this.str(a)||this.num(a))return(""+a).split("").reverse().join("")},rpad:function(a,b,d,e){return this.pad(a,b,d,e,!0)},rtrim:function(a,b){if(!this.str(a))return a;b=this.str(b)?this.rescape(b):" \t\n\r";return a.replace(RegExp("["+b+"]+$","g"),"")},search:function(a,
b,d){var e=null,f=null,g=null;if(this.obj(b,!0)||this.arr(b))for(e in b){if(e==a)return d?e:b[e];if(this.obj(b[e],!0)||this.arr(b[e]))if(g=this.search(a,b[e],!0),f=e+"."+g,this.str(g))return d?f:this.walk(f,b)}},serial:function(a){var b=[];if(!this.obj(a))return"";for(var d in a)a.hasOwnProperty(d)&&(this.arr(a[d])?b.push.apply(b,a[d].map(function(a){return escape(d+"[]")+"="+escape(a)})):this.obj(a[d])?b.push(escape(d)+"="+escape(this.serial(a[d]))):this.func(a[d])||b.push(escape(d)+"="+escape(a[d])));
return 0<this.count(b)?b.join("&"):!1},str:function(a,b){return"string"===typeof a&&(b||0<a.length)},sum:function(a,b){var d=0,e;if(this.num(a))return a;if(this.obj(a))for(e in a)a.hasOwnProperty(e)&&(this.obj(a[e])&&!b?d=1*d+sum(a[e]):this.num(a[e],!0)&&(d=1*d+a[e]));return d},time2time:function(a){var b=parseInt(a,10),d={d:0,h:0,m:0,s:0};if(this.num(a,!0))return this.num(b)&&(86400<b&&(d.d=parseInt(b/86400,10),b=parseInt(b-86400*d.d,10)),3600<b&&(d.h=parseInt(b/3600,10),b=parseInt(b-3600*d.h,10)),
60<b&&(d.m=parseInt(b/60,10),b=parseInt(b-60*d.m,10)),0<b&&(d.s=b)),d},toke:function(a,b,d,e){if(this.str(a)){var f=String(a);d="undefined"==typeof d||!d?"i":"";b=this.obj(b)?b:{};this.str(e)?e={l:String(e),r:String(e)}:this.arr(e)&&2==e.length&&this.str(e[0])&&this.str(e[1])?e={l:e[0],r:e[1]}:(e=this.obj(e)?e:{},e.l=this.str(e.l)?e.l:"##",e.r=this.str(e.r)?e.r:"##");for(var g in b)if(b.hasOwnProperty(g)&&this.str(g)&&(this.str(b[g])||this.num(b[g],!0)))a=RegExp(this.rescape(""+e.l+g+e.r),"g"+d),
f=f.replace(a,b[g])}return f},trim:function(a,b){if(!this.str(a))return a;b=this.str(b)?this.rescape(b):" \t\n\r";return a.replace(RegExp("(^["+b+"]+|["+b+"]+$)","g"),"")},trueish:function(a){switch(typeof a){case "function":return String(a);case "string":return/^\s*(on|true|yes|1|yar|checked|selected)\s*$/i.test(a);case "object":return this.obj(a,!0);default:return a?!0:!1}},txt2html:function(a,b){var d=!1,e=["&",'"',"<",">"],f=""+a,g=null,h={"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;","\u00a9":"&copy;",
"\u00ae":"&reg;"};if(this.str(a)){this.obj(this.txt2html._cache)||(this.txt2html._cache={});this.typeis(b,"Boolean")?d=b:this.arr(b)&&(e=b,d=!1);for(var k=0;k<a.length;k++)if(this.str(a[k])&&(g=RegExp(this.rescape(a[k]),"g"),this.str(this.txt2html._cache[a[k]])||(this.txt2html._cache[a[k]]=this.str(h[a[k]])?h[a[k]]:"&#"+a[k].charCodeAt(0)+";"),d||this.num(this.find(a[k],e),-1)))f=f.replace(g,this.txt2html._cache[a[k]]);return f}},typeis:function(a,b){if("undefined"!=typeof a&&this.str(b))return Object.prototype.toString.call(a)===

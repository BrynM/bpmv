...
( typeof(bpmv) === 'object' ) && ( typeof(bpmv.clog) != 'object' ) && ( function () {
	...
	*******************************************************************************/
	...
	/*
	* enable/disable - Set this with your debug flag if you wish. You can also
	* set it before this file loads if bpmv has already been loaded.
	*/
	bpmv._cEnabled = typeof(bpmv._cEnabled) == 'undefined' ? true : bpmv._cEnabled;
	...
	bpmv._cCon = function ( key ) {
		if ( ( this._cStored === 'wood' ) || !bpmv._cEnabled ) {
			return;
		}
